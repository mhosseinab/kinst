...
class StatusExpertAmount extends Component {
  state = {
    data: [],
    props: null,
  ...
  fetch = () => {
    ...
    request
      .post(
        `${API_BASE_URL}/admin/api/v1/search/res/malasto`,
...
export default StatusExpertAmount;
