...
const EditForm = Form.create({ name: 'edit_form' })(
        ...
        <Form layout="vertical">
          <Form.Item label="نام کاربری">
            {getFieldDecorator('username', {
              ...
              rules: [{ required: true, message: 'لطفا نام کاربری وارد کنید!' }],
            })(<Input className="input-ltr english-font" />)}
          </Form.Item>

          <Form.Item label="کلمه عبور">
            <div>
              <p>اگر نیازی به تغییر رمز عبور ندارید این بخش را خالی بگذارید</p>
            </div>
          ...
          <Form.Item label="سطح دسترسی">
            {getFieldDecorator('role', {
              ...
              rules: [{ required: true, message: 'لطفا سطح دسترسی را انتخاب کنید' }],
            })(
              <Select>
          ...
          <Form.Item label="استان">
            {getFieldDecorator('province', {
              ...
              <Select mode="multiple">
                ...
                <Option key='012'>012 - توزيع نيروي برق آذربايجان شرقي</Option>
                <Option key='013'>013 - توزيع نيروي برق آذربايجان غربي</Option>
                <Option key='014'>014 - توزيع نيروي برق اردبيل</Option>
                <Option key='021'>021 - توزيع نيروي برق شهرستان اصفهان</Option>
                <Option key='022'>022 - توزيع نيروي برق استان اصفهان</Option>
                <Option key='023'>023 - توزيع نيروي برق چهارمحال بختياري</Option>
                ...
                <Option key='052'>052 - توزيع نيروي برق استان خراسان رضوي</Option>
                <Option key='053'>053 - توزيع نيروي برق استان خراسان شمالي</Option>
                <Option key='054'>054 - توزيع نيروي برق استان خراسان جنوبي</Option>
                <Option key='061'>061 - توزيع نيروي برق شهرستان اهواز</Option>
                <Option key='062'>062 - توزيع نيروي برق استان خوزستان</Option>
                <Option key='063'>063 - توزيع نيروي برق کهکيلويه و بويراحمد</Option>
                ...
                <Option key='091'>091 - توزيع نيروي برق استان سيستان و بلوچستان</Option>
                <Option key='101'>101 - توزيع نيروي برق استان کرمانشاه</Option>
                ...
                <Option key='121'>121 - توزيع نيروي برق شمال استان کرمان</Option>
                <Option key='122'>122 - توزيع نيروي برق جنوب استان کرمان</Option>
                <Option key='131'>131 - توزيع نيروي برق استان گيلان</Option>
                <Option key='141'>141 - توزيع نيروي برق استان مازندران</Option>
                <Option key='142'>142 - توزيع نيروي برق غرب استان مازندران</Option>
